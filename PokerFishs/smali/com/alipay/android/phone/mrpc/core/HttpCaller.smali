...
.method public call()Ljava/lang/Object;
    ...
    new-instance v0, Lcom/alipay/android/phone/mrpc/core/HttpUrlRequest;

    iget-object v1, p0, Lcom/alipay/android/phone/mrpc/core/HttpCaller;->mConfig:Lcom/alipay/android/phone/mrpc/core/Config;

    invoke-interface {v1}, Lcom/alipay/android/phone/mrpc/core/Config;->getUrl()Ljava/lang/String;

    move-result-object v1

    invoke-direct {v0, v1}, Lcom/alipay/android/phone/mrpc/core/HttpUrlRequest;-><init>(Ljava/lang/String;)V

    iget-object v1, p0, Lcom/alipay/android/phone/mrpc/core/HttpCaller;->mReqData:[B

    invoke-virtual {v0, v1}, Lcom/alipay/android/phone/mrpc/core/HttpUrlRequest;->setReqData([B)V

    iget-object v1, p0, Lcom/alipay/android/phone/mrpc/core/HttpCaller;->mContentType:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcom/alipay/android/phone/mrpc/core/HttpUrlRequest;->setContentType(Ljava/lang/String;)V

    iget-boolean v1, p0, Lcom/alipay/android/phone/mrpc/core/HttpCaller;->mResetCookie:Z

    invoke-virtual {v0, v1}, Lcom/alipay/android/phone/mrpc/core/HttpUrlRequest;->setResetCookie(Z)V
    ...
    invoke-virtual {v0, v1, v2}, Lcom/alipay/android/phone/mrpc/core/HttpUrlRequest;->addTags(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v0}, Lcom/alipay/android/phone/mrpc/core/HttpCaller;->addHeader(Lcom/alipay/android/phone/mrpc/core/HttpUrlRequest;)V
    ...
    invoke-virtual {v0}, Lcom/alipay/android/phone/mrpc/core/HttpUrlRequest;->toString()Ljava/lang/String;
    ...
    invoke-interface {v1, v0}, Lcom/alipay/android/phone/mrpc/core/Transport;->execute(Lcom/alipay/android/phone/mrpc/core/Request;)Ljava/util/concurrent/Future;
    ...
    :cond_0
    :try_start_1
    invoke-virtual {v0}, Lcom/alipay/android/phone/mrpc/core/Response;->getResData()[B
    :try_end_1
    ...
    invoke-direct {p0, v2}, Lcom/alipay/android/phone/mrpc/core/HttpCaller;->transferCode(I)I

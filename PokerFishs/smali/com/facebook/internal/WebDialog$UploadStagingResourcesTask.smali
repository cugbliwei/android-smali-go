...
.method protected varargs doInBackground([Ljava/lang/Void;)[Ljava/lang/String;
    ...
    .prologue
    .line 721
    iget-object v12, p0, Lcom/facebook/internal/WebDialog$UploadStagingResourcesTask;->parameters:Landroid/os/Bundle;
    ...
    iput-object v12, p0, Lcom/facebook/internal/WebDialog$UploadStagingResourcesTask;->exceptions:[Ljava/lang/Exception;
    ...
    .line 730
    .local v9, "tasks":Ljava/util/concurrent/ConcurrentLinkedQueue;, "Ljava/util/concurrent/ConcurrentLinkedQueue<Lcom/facebook/GraphRequestAsyncTask;>;"
    ...
    .line 735
    .local v8, "task":Landroid/os/AsyncTask;
    const/4 v12, 0x1

    invoke-virtual {v8, v12}, Landroid/os/AsyncTask;->cancel(Z)Z
    :try_end_0
    ...
    .end local v8    # "task":Landroid/os/AsyncTask;
    :catch_0
    move-exception v2
    ...
    .line 784
    .restart local v8    # "task":Landroid/os/AsyncTask;
    const/4 v12, 0x1
    ...
    .line 741
    .local v11, "writeIndex":I
    invoke-static {v10}, Lcom/facebook/internal/Utility;->isWebUri(Landroid/net/Uri;)Z
    ...
    invoke-direct {v1, p0, v7, v11, v5}, Lcom/facebook/internal/WebDialog$UploadStagingResourcesTask$1;-><init>(Lcom/facebook/internal/WebDialog$UploadStagingResourcesTask;[Ljava/lang/String;ILjava/util/concurrent/CountDownLatch;)V

    .line 774
    .local v1, "callback":Lcom/facebook/GraphRequest$Callback;
    invoke-static {v0, v10, v1}, Lcom/facebook/share/internal/ShareInternalUtility;->newUploadStagingResourceWithImageRequest(Lcom/facebook/AccessToken;Landroid/net/Uri;Lcom/facebook/GraphRequest$Callback;)Lcom/facebook/GraphRequest;
    ...
    .line 779
    .local v8, "task":Lcom/facebook/GraphRequestAsyncTask;
    ...
    .end local v8    # "task":Lcom/facebook/GraphRequestAsyncTask;
    .end local v10    # "uri":Landroid/net/Uri;
    .end local v11    # "writeIndex":I
    :cond_3
...
.method protected onPostExecute([Ljava/lang/String;)V
    ...
    const-string v9, "Failed to stage photos for web dialog"

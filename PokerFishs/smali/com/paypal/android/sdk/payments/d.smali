...
.method static a(Landroid/app/Activity;Lcom/paypal/android/sdk/ft;Lcom/paypal/android/sdk/ft;Landroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog;
    .locals 3
    ...
    invoke-static {p1}, Lcom/paypal/android/sdk/fr;->a(Lcom/paypal/android/sdk/ft;)Ljava/lang/String;
    ...
    invoke-static {p2}, Lcom/paypal/android/sdk/fr;->a(Lcom/paypal/android/sdk/ft;)Ljava/lang/String;
...
.method private static a(Landroid/content/Context;Lcom/paypal/android/sdk/ft;Ljava/lang/String;Landroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog;
    .locals 4
...
.method static a(Landroid/app/Activity;Lcom/paypal/android/sdk/ft;Landroid/os/Bundle;)Landroid/app/Dialog;
    .locals 2
    ...
    invoke-static {p0, p1, v0, v1}, Lcom/paypal/android/sdk/payments/d;->a(Landroid/content/Context;Lcom/paypal/android/sdk/ft;Ljava/lang/String;Landroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog;
...
.method static a(Landroid/app/Activity;Lcom/paypal/android/sdk/ft;Landroid/os/Bundle;I)Landroid/app/Dialog;
    .locals 2
...
.method static a(Landroid/app/Activity;Lcom/paypal/android/sdk/ft;Landroid/os/Bundle;Landroid/content/DialogInterface$OnClickListener;)Landroid/app/Dialog;
    .locals 1
    ...
    invoke-static {p0, p1, v0, p3}, Lcom/paypal/android/sdk/payments/d;->a(Landroid/content/Context;Lcom/paypal/android/sdk/ft;Ljava/lang/String;Landroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog;
...
.method static a(Landroid/content/Context;Lcom/paypal/android/sdk/ft;Lcom/paypal/android/sdk/ft;)Landroid/app/Dialog;
    .locals 2
...
.method public static a(Landroid/app/Activity;Ljava/lang/Enum;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v0, p0}, Lcom/paypal/android/sdk/cw;->c(Ljava/lang/String;Landroid/content/Context;)Landroid/graphics/Bitmap;
...
.method public static a(Lcom/paypal/android/sdk/dq;)Ljava/lang/Enum;
    .locals 6
    ...
    invoke-virtual {p0}, Lcom/paypal/android/sdk/dq;->h()Lcom/paypal/android/sdk/ds;

    move-result-object v5

    invoke-virtual {v5}, Lcom/paypal/android/sdk/ds;->toString()Ljava/lang/String;
...
.method public static a(Lcom/paypal/android/sdk/ct;)Ljava/lang/Object;
    .locals 6

    instance-of v0, p0, Lcom/paypal/android/sdk/fa;

    if-eqz v0, :cond_0

    check-cast p0, Lcom/paypal/android/sdk/fa;

    new-instance v0, Lcom/paypal/android/sdk/payments/ProofOfPayment;

    invoke-virtual {p0}, Lcom/paypal/android/sdk/fa;->v()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p0}, Lcom/paypal/android/sdk/fa;->t()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {p0}, Lcom/paypal/android/sdk/fa;->w()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {p0}, Lcom/paypal/android/sdk/fa;->x()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {p0}, Lcom/paypal/android/sdk/fa;->y()Ljava/lang/String;
    ...
    :cond_0
    instance-of v0, p0, Lcom/paypal/android/sdk/fe;

    if-eqz v0, :cond_1

    check-cast p0, Lcom/paypal/android/sdk/fe;

    new-instance v0, Lcom/paypal/android/sdk/payments/ProofOfPayment;

    invoke-virtual {p0}, Lcom/paypal/android/sdk/fe;->C()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p0}, Lcom/paypal/android/sdk/fe;->D()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {p0}, Lcom/paypal/android/sdk/fe;->F()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {p0}, Lcom/paypal/android/sdk/fe;->E()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {p0}, Lcom/paypal/android/sdk/fe;->G()Ljava/lang/String;
...
.method static a(Landroid/app/Activity;Landroid/widget/TextView;Lcom/paypal/android/sdk/ft;)V
    .locals 4
    ...
    invoke-static {v1, p0, v2}, Lcom/paypal/android/sdk/cw;->a(Ljava/lang/String;Landroid/content/Context;I)Landroid/graphics/Bitmap;
...
.method static a(Landroid/app/Activity;Lcom/paypal/android/sdk/payments/cf;III)V
    ...
    sget-object v0, Lcom/paypal/android/sdk/ft;->bd:Lcom/paypal/android/sdk/ft;
    ...
    sget-object v2, Lcom/paypal/android/sdk/by;->e:Lcom/paypal/android/sdk/by;
    ...
    sget-object v0, Lcom/paypal/android/sdk/ft;->bj:Lcom/paypal/android/sdk/ft;
    ...
    :cond_6
    sget-object v0, Lcom/paypal/android/sdk/ft;->bb:Lcom/paypal/android/sdk/ft;
...
.method static a(Landroid/widget/TextView;Ljava/lang/String;)V
    ...
    invoke-static {p1}, Lcom/paypal/android/sdk/bo;->c(Ljava/lang/String;)Z
    ...
    :cond_2
    invoke-static {p1}, Lcom/paypal/android/sdk/bo;->b(Ljava/lang/String;)Z

    move-result v0

    if-eqz v0, :cond_3

    sget-object v0, Lcom/paypal/android/sdk/ft;->ag:Lcom/paypal/android/sdk/ft;
    ...
    :cond_3
    invoke-static {p1}, Lcom/paypal/android/sdk/bo;->a(Ljava/lang/String;)Z

    move-result v0

    if-eqz v0, :cond_4

    sget-object v0, Lcom/paypal/android/sdk/ft;->af:Lcom/paypal/android/sdk/ft;
...
.method public c()Ljava/lang/String;
    ...
    const-string v0, "07eb1dddd5e7f4734f7e976348831771d1c528e2"
